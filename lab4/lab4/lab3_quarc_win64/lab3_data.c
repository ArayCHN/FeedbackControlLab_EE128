...
P_lab3_T lab3_P = {
  ...
  0.0,                                 /* Expression: watchdog_pwm_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  2.2846698652044781E-5,               /* Expression: 1/43770
                                        * Referenced by: '<Root>/Gain1'
                                        */
  -250.0,                              /* Computed Parameter: TransferFcn_A
                                        * Referenced by: '<Root>/Transfer Fcn'
                                        */
  -575000.0,                           /* Computed Parameter: TransferFcn_C
                                        * Referenced by: '<Root>/Transfer Fcn'
                                        */
  2500.0,                              /* Computed Parameter: TransferFcn_D
                                        * Referenced by: '<Root>/Transfer Fcn'
                                        */
  6.0,                                 /* Expression: 6
